...
void load_player_from_db(Player *player) {
    ...
    if (step == SQLITE_ROW) {
        ...
        player->attack = sqlite3_column_int(res, 3);
        player->gold = sqlite3_column_int(res, 4);
        player->mana = sqlite3_column_int(res, 5);
        player->defense = sqlite3_column_int(res, 6);
        player->sizeInventaire = sqlite3_column_int(res, 7);
        player->x = sqlite3_column_int(res, 8);
        player->y = sqlite3_column_int(res, 9);
        player->xp = sqlite3_column_int(res, 10);
        player->level = sqlite3_column_int(res, 11);
        player->xpForNextLvl = sqlite3_column_int(res, 12);
        player->lifePotion = sqlite3_column_int(res, 13);
        player->manaPotion = sqlite3_column_int(res, 14);
